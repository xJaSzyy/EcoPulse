...
public class ConsulRegistrationService : BackgroundService
{
    ...
    private async Task RegisterWithConsul(CancellationToken ct)
    {
        ...
        var serviceAddress = _configuration.GetValue<string>("Consul:ServiceAddress") ?? "traffic-service:5000";
        var serviceName = _configuration.GetValue<string>("Consul:ServiceName") ?? "traffic";
